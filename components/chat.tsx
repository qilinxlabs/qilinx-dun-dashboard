...
import { useChatHistory } from "@/components/chat-layout-client";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function Chat({
  ...
  // Get chat history toggle from context
  const { showChatHistory, toggleChatHistory } = useChatHistory();
  ...
  // Mark initial messages as historical to prevent re-execution of tools
  const [historicalMessageIds] = useState(() => 
  ...
  const {
    ...
    experimental_throttle: 50, // Reduced from 100ms for faster streaming
